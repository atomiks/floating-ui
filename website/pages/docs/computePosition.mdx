...
These are the plugins, or middleware, to **alter** the base
`placement` in some fashion, or provide useful data to the
consumer. 7 core modifiers are included in the package, which
...
Importantly, you can also craft your own custom modifiers to
