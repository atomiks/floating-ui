...
that doesn't fit, then `right` will be used instead. If `right`
also doesn't fit, then `bottom` will be used. If none of these
fit, then the best-fitting placement will be used.
